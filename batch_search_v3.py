...
class BatchSearch:
    ...
    def batch_search(self,masses=None,formulas=None,directory='',by_formula=True,ppm=10):
        ...
        options.set_headless(headless=True)  # change this to false to see the browser in action
        ...
        # EXpoCast
        #self.driver.find_element_by_xpath('//*[@value="expocast"]').click() #TODO - What was this? No longer exists?
